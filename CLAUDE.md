...
| [dry-99-review-mode-prompt](docs/decisions/dry-99-review-mode-prompt.md) | which prompt a spawn gets from the ticket's Switchyard `review_mode` — and why an absent mode is not `null` |
